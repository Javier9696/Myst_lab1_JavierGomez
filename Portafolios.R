...
### Especificar resticciones del portafolio
### en ste caso especificaremos 2 restricciones: Restricción1: la suma de todos los pesos debe ser 1, es decir,
### Invertir el 100% del capital en el portafolio
